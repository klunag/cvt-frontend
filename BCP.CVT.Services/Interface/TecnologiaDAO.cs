...
namespace BCP.CVT.Services.Interface
{
    public abstract partial class TecnologiaDAO : ServiceProvider
    {
        ...
        public abstract List<TecnologiaOwnerConsolidadoObsolescenciaDTO> ListarTecnologiaOwnerConsolidadoObsolescenciaReporte2(string dominioIds, string subDominioIds, string productoStr, string tecnologiaStr, string ownerStr, string squadId);
        #endregion
