...
var $tblClasificacion = $("#tblClasificacion");
var $tblSubClasificacion = $("#tblSubclasificacion");
var DATA_EXPORTAR = {};
var DATOS_RESPONSABLE = {};

const URL_API_VISTA = URL_API + "/Aplicacion/ConfiguracionPortafolio";
const TITULO_MENSAJE = "Clasificación y subclasificación técnica";
...
const TABLE_NIVELES = [
    {
        Table: $tblClasificacion,
        UrlListado: "ListarClasificacion",
        UrlGetById: "GetClasificacionById",
        UrlAddOrEdit: "AddOrEditClasificacion",
        UrlCambiarEstado: "CambiarEstadoClasificacion",
        Mantenimiento: ENTIDAD_MANTENIMIENTO.ClasificacionTecnica,
        TitleModal: "Clasificación técnica",
        classField: "registroField",
        Nivel: TREE_NIVEL.Uno
    },
    {
        Table: $tblSubClasificacion,
        UrlListado: "ListarSubclasificacion",
        UrlGetById: "GetSubclasificacionById",
        UrlAddOrEdit: "AddOrEditSubclasificacion",
        UrlCambiarEstado: "CambiarEstadoSubclasificacion",
        Mantenimiento: ENTIDAD_MANTENIMIENTO.SubclasificacionTecnica,
        TitleModal: "Subclasificación técnica",
        classField: "registroField",
