...
function ListarRegistros() {
    ...
    $table.bootstrapTable({
        url: URL_API_GESTION + "/ListarFormatosRegistro",
...
function opcionesFormatter(value, row) {
    ...
    verFicha = `<a href="FichaFormatoRegistro?id=${row.AppId}&&nom_App=${nombre_app}&paginaActual=${ULTIMO_PAGE_NUMBER}&paginaTamanio=${ULTIMO_REGISTRO_PAGINACION}" title="Ver ficha y editar"><i class="glyphicon glyphicon-share table-icon"></i></a>`;
