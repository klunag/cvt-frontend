...
var URL_API_VISTA = URL_API + "/Justificacion";
var DATA_EXPORTAR = {};
var TITULO_MENSAJE = "Justificaciones";
...
$(function () {
    ...
    InitAutocompletarBuilder($("#txtTecnologia"), $("#hTecnologia"), ".containerFiltroTecnologia", "/Tecnologia/GetTecnologiaByFiltro?filtro={0}");
...
function listarRegistros() {
    ...
    $table.bootstrapTable({
        ...
        queryParams: function (p) {
            ...
            DATA_EXPORTAR.TecnologiaId = $("#hTecnologia").val();
            DATA_EXPORTAR.Aplicacion = $("#hAplicacion").val();
            DATA_EXPORTAR.EquipoId = $("#hEquipo").val();
...
function ExportarInfo() {
    ...
    let url = `${URL_API_VISTA}/Exportar?ProductoId=${DATA_EXPORTAR.ProductoId}&TecnologiaId=${DATA_EXPORTAR.TecnologiaId}&EquipoId=${DATA_EXPORTAR.EquipoId}&Aplicacion=${DATA_EXPORTAR.Aplicacion}&ProcesoId=${DATA_EXPORTAR.ProcesoId}&PuertoId=${DATA_EXPORTAR.PuertoId}&ProtocoloId=${DATA_EXPORTAR.ProtocoloId}&Fecha=${DATA_EXPORTAR.Fecha}&sortName=${DATA_EXPORTAR.sortName}&sortOrder=${DATA_EXPORTAR.sortOrder}`;
    $.ajax({
        url: url,
