...
function listarRegistros() {
    if ($("#formFiltros").valid()) {
        ...
        $table.bootstrapTable({
            url: URL_API_VISTA + "/Listado/Equipos",
            method: 'POST',
            pagination: true,
            ...
            queryParams: function (p) {
                ...
                DATA_EXPORTAR.SoftwareBase = '';
                DATA_EXPORTAR.TieneReplica = $("#dlReplica").val();
...
function ExportarInfo() {
    ...
    let url = `${URL_API_VISTA}/Listado/Equipos/Exportar?equipo=${DATA_EXPORTAR.Equipo}&storage=${DATA_EXPORTAR.Storage}&fecha=${DATA_EXPORTAR.Fecha}&softwareBase=${DATA_EXPORTAR.SoftwareBase}&replica=${DATA_EXPORTAR.TieneReplica}`;
    $.ajax({
        url: url,
