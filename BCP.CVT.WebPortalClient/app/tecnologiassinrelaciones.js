...
var DATA_EXPORTAR = {};
var TITULO_MENSAJE = "Tecnologías no relacionadas con aplicaciones";
...
$(function () {
    ...
    $("#ddlDominio").on('change', function () {
        ...
        getSubdominiosByDomCbMultiple($("#ddlSubdominio"), $("#ddlDominio"));
    });
    ...
    if (FLAG_ADMIN == 1) {
        $("#ddlDominio, #ddlSubdominio").addClass("ignore");
        listarRegistros();
    } else {
        $("#ddlDominio, #ddlSubdominio").removeClass("ignore");
...
function ValidarCampos() {
    $("#formFiltros").validate({
        ...
        errorPlacement: (error, element) => {
            if (element.attr('name') === "ddlDominio" || element.attr('name') === "ddlSubdominio" || element.attr('name') === "FechaFiltro") {
...
function setItemsCb(cbx, ctrlx) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            SetItemsMultiple(data, $cb, TEXTO_TODOS, TEXTO_TODOS, true);
            //SetDataToSelectMultiple(arrMultiSelect, [{ Subdominio: data }]);
...
function listarRegistros() {
    ...
    if ($("#formFiltros").valid()) {
        ...
        $table.bootstrapTable({
            url: URL_API_DASHBOARD + "/Reportes/Tecnologias/SinRelaciones",
            method: 'POST',
...
function ExportarInfo() {
    ...
    let url = `${URL_API_DASHBOARD}/Reportes/Tecnologias/SinRelaciones/Exportar?dominio=${DATA_EXPORTAR.DominioIds}&subdominio=${DATA_EXPORTAR.SubdominioIds}&estadoAprobacion=${DATA_EXPORTAR.EstadoAprobacionIds}&familia=${DATA_EXPORTAR.Familia}&tipo=${DATA_EXPORTAR.Tipos}&estadoObsolescencia=${DATA_EXPORTAR.EstadoObsolescencias}&clave=${DATA_EXPORTAR.Clave}&sortName=${DATA_EXPORTAR.sortName}&sortOrder=${DATA_EXPORTAR.sortOrder}&Fecha=${DATA_EXPORTAR.Fecha}`;
    $.ajax({
        url: url,
