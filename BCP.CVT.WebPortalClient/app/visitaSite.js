...
var DATA_EXPORTAR = {};
var TITULO_MENSAJE = "Visitas del Site";
...
function listarTipos() {
    ...
    $table.bootstrapTable('destroy').bootstrapTable({
        locale: 'es-SP',
        url: URL_API_VISTA + "/ListarVisitaSite",
        method: 'POST',
        ...
        queryParams: function (p) {
            DATA_EXPORTAR = {};
            DATA_EXPORTAR.Matricula = $.trim($("#txtFilMatricula").val());
            DATA_EXPORTAR.Nombre = $.trim($("#txtFilNombre").val());
...
function ExportarInfo() {
    ...
    let url = `${URL_API_VISTA}/ExportarVisitaSite?Matricula=${DATA_EXPORTAR.Matricula}&Nombre=${DATA_EXPORTAR.Nombre}&FechaDesde=${DATA_EXPORTAR.FechaDesde}&FechaHasta=${DATA_EXPORTAR.FechaHasta}&sortName=${DATA_EXPORTAR.sortName}&sortOrder=${DATA_EXPORTAR.sortOrder}`;
    $.ajax({
        url: url,
